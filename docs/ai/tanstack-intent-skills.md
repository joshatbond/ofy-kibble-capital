...
TanStack ships optional **Intent** skills for agents working on Start, Router, and Devtools. Load a skill with:
...
## ofy-kibble-capital notes

- Prefer these skills for **TanStack Start / Router / Devtools** tasks in this repo.
- For **authentication**, follow [`docs/ai/auth.md`](auth.md) (Convex Auth + invite-only). The Router skill `router-core/auth-and-guards` describes TanStack patterns; do not adopt Clerk/Auth0 from that skill unless the project explicitly changes auth.
- **SSR scope:** only Kibble and PawKet **marketing landings** use SSR; signed-in student apps, admin, and Convex Auth routes stay client-first per [`architecture-foundation.md`](architecture-foundation.md).
- **Deploy:** production builds use Netlify + dynamic Netlify plugin import on `vite build` only — see `vite.config.ts`.

## By area

| Area                   | `use` identifiers                                                                                                                                                                                                              |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Devtools (app)         | `@tanstack/devtools#devtools-app-setup`                                                                                                                                                                                        |
| Devtools (marketplace) | `@tanstack/devtools#devtools-marketplace`                                                                                                                                                                                      |
| Devtools (panels)      | `@tanstack/devtools#devtools-plugin-panel`                                                                                                                                                                                     |
| Devtools (production)  | `@tanstack/devtools#devtools-production`                                                                                                                                                                                       |
| Devtools (events)      | `@tanstack/devtools-event-client#devtools-bidirectional`, `#devtools-event-client`, `#devtools-instrumentation`                                                                                                                |
| Devtools (Vite)        | `@tanstack/devtools-vite#devtools-vite-plugin`                                                                                                                                                                                 |
| Start (core)           | `@tanstack/react-start#react-start`, `#react-start/server-components`, `#lifecycle/migrate-from-nextjs`                                                                                                                        |
| Start (platform)       | `@tanstack/start-client-core#start-core`, `#start-core/auth-server-primitives`, `#start-core/deployment`, `#start-core/execution-model`, `#start-core/middleware`, `#start-core/server-functions`, `#start-core/server-routes` |
| Start (server)         | `@tanstack/start-server-core#start-server-core`                                                                                                                                                                                |
| Router (core)          | `@tanstack/router-core#router-core` and topics under `#router-core/*`                                                                                                                                                          |
| Router (bundler)       | `@tanstack/router-plugin#router-plugin`                                                                                                                                                                                        |
| Virtual routes         | `@tanstack/virtual-file-routes#virtual-file-routes`                                                                                                                                                                            |

## Full mappings (intent-skills)
